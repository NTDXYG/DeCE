...
class GPT2LM():
    def __init__(self, parallel):
        ...
        self.tokenizer = transformers.GPT2TokenizerFast.from_pretrained("/home/yangguang/models/CodeGPT-small-java-adaptedGPT2")
        self.lm = transformers.GPT2LMHeadModel.from_pretrained("/home/yangguang/models/CodeGPT-small-java-adaptedGPT2",
    ...
    def __call__(self, sents):
        ...
        ipt = self.tokenizer(sents, return_tensors="pt", padding=True, truncation=True, 
                            max_length=150, verbose=False).to(self.device)
