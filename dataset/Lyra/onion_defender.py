...
class GPT2LM():
    def __init__(self, parallel):
        ...
        self.tokenizer = transformers.GPT2TokenizerFast.from_pretrained("/media/yangguang/E/models/gpt2")
        self.lm = transformers.GPT2LMHeadModel.from_pretrained("/media/yangguang/E/models/gpt2",
